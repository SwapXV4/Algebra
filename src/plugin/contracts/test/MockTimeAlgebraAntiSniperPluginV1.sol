...
contract MockTimeAlgebraAntiSniperPluginV1 is AlgebraAntiSniperPluginV1 {
  ...
  constructor(
    ...
    AuxFeeData memory _feeData
  ) AlgebraAntiSniperPluginV1(_pool, _factory, _pluginFactory, _feeData) {
    //
  }
